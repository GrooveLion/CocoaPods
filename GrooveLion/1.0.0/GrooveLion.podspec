Pod::Spec.new do |s|
  ...
  s.license = { :type=>'Commercial', :file => "GLESDK_1.0.0/LICENSE.txt" }
  ...
  s.source       = { :http => "http://sdk.groovelion.com/iOS/GLESDK_1.0.0.zip", :flatten => true }

  s.source_files = 'GLESDK_1.0.0/GLESDK.h'
  s.preserve_paths = 'GLESDK_1.0.0/libGLESDK.a'
  s.libraries = 'GLESDK'

  s.frameworks = 'Foundation', 'UIKit', 'CoreLocation'

  s.requires_arc = true
  s.xcconfig = { 'LIBRARY_SEARCH_PATHS' => '$(PODS_ROOT)/GrooveLion/GLESDK_1.0.0' }
